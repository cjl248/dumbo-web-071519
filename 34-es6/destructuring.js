...
/*
  ...
  const { name, population, founded, baseballTeam: basketballTeam } = borough;
...
const greet = ({ spicyName }) => `Hello, ${ spicyName } Spice!`;

function greet({ spicyName, participatingIn2019ReunionTour: touring }, otherThing, ...otherStuff) {
...
console.log(greet(me, {}, "dfhjksdf", 25423423, []))
